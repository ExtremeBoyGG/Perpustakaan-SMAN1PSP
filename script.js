    ...
    if (query.length < minLength || query === "") {
        ...
        if (filteredBooks.length === 0) {
            ...
            filteredBooks.forEach(book => {
                ...
                bookItem.innerHTML = `<a href="${book.url}" target="_blank" class="block text-blue-600 hover:underline">${book.title}</a>`;
